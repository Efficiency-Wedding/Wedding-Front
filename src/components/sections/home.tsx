        ...
        <div className="w-full lg:w-1/3 flex items-center px-4 sm:px-10 py-8">
          <div>
            ...
            <p className="text-gray-600 text-base sm:text-lg mb-6 text-justify">
              Wedding planner professionnel à Madagascar. Nous organisons votre
              mariage de A à Z pour faire de votre grand jour un moment
              inoubliable.
            </p>
            <Link to="/admin">
            ...
            <div className="flex items-center mt-5">
              ...
              <img
                src={photo2}
                className="w-10 sm:w-12 h-10 sm:h-12 rounded-full border-2 border-white -ml-3 object-cover"
              />
              <img
                src={photo3}
                className="w-10 sm:w-12 h-10 sm:h-12 rounded-full border-2 border-white -ml-3 object-cover"
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-stretch text-center lg:text-left gap-6 lg:gap-0 px-4 sm:px-10 py-6 bg-primary-light rounded-xl mx-2 sm:mx-6 mb-10">
        ...
        <div className="w-full lg:w-1/3 flex justify-center items-center lg:px-8 lg:border-l lg:border-r border-gray-300">
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed font-medium text-center max-w-sm">
            Que vous rêviez d'une cérémonie intime ou d'une réception grandiose,
            nous nous occupons de tout : décoration, salle, traiteur, animation,
            photo, vidéo et coordination du Jour J.
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-10 py-20 items-center">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            Notre équipe accompagne les futurs mariés dans chaque étape de
            l'organisation. De la conception du thème à la coordination du Jour
        ...
        <div className="flex justify-between items-end mb-12">
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            <p className="text-gray-600 text-sm text-right max-w-xs">
              Des prestations soignées pour un mariage inoubliable, élégant et
              plein d’émotions.
            </p>
          </div>
        </div>
      ...
      <div className="py-20 flex flex-col gap-6">
        <div className="flex justify-between items-end mb-12">
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            <p className="text-gray-600 text-sm text-right max-w-xs">
              Des couples heureux partagent leur expérience et les moments
              inoubliables de leur mariage.
            </p>
          </div>
        </div>
        <TestimonialCard
