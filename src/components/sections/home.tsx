...
const Home: FC<Props> = () => {
    return (
        ...
        >
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-stretch text-center lg:text-left gap-6 lg:gap-0 px-4 sm:px-10 py-6 bg-primary-light rounded-xl mx-2 sm:mx-6">
