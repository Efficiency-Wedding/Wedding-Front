...
const icons = {
  ...
  music:
    "M9 18V5l12-2v13 M6 21a3 3 0 100-6 3 3 0 000 6z M18 19a3 3 0 100-6 3 3 0 000 6z",
  ...
  sparkle:
    "M12 2L9.927 9.927 2 12l7.927 2.073L12 22l2.073-7.927L22 12l-7.927-2.073L12 2z",
  headset:
  ...
  phone:
    "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.09 9.76a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .84h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z",
...
const services = [
  {
    ...
    testimonial: {
      text: "Un festin extraordinaire, nos invités en parlent encore !",
      author: "Marie & Thomas, juin 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "La salle était féerique, exactement comme nous la rêvions !",
      author: "Sophie & Julien, mars 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "Chaque photo capture parfaitement l'émotion du moment.",
      author: "Léa & Pierre, décembre 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "La piste de danse n'a jamais été vide, fantastique !",
      author: "Camille & Romain, août 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "Les fleurs étaient absolument magnifiques, un conte de fées !",
      author: "Amandine & Hugo, mai 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "Arriver en Rolls-Royce était un rêve devenu réalité !",
      author: "Isabelle & Marc, octobre 2024",
    },
    duration: "Journée complète",
    guests: "Sur mesure",
    tag: "Prestige",
  },
  {
    ...
    testimonial: {
      text: "Je me suis sentie rayonnante toute la journée, merci !",
      author: "Clara & Kevin, juillet 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "Un gâteau aussi beau que délicieux, nos invités ont adoré !",
      author: "Élodie & Maxime, novembre 2024",
    },
  ...
  },
  {
    ...
    testimonial: {
      text: "Les feux d'artifice à minuit étaient magiques, mémorable !",
      author: "Juliette & Nathan, septembre 2024",
    },
...
const packages = [
  ...
  },
  {
    ...
    cols: [
      ...
      [
        "Couverture vidéo complète",
        "Family portraits",
        "Retouche pro",
        "Montage cinéma",
        "USB clé personnalisée",
        "Couple song editing",
        "Picture songs editing",
      ],
    ],
    popular: true,
  },
...
const timeline = [
  {
    ...
    desc: "Échangez avec nos experts pour définir votre vision de rêve.",
  },
  {
    icon: "check",
    step: "02",
    title: "Choix des services",
    desc: "Sélectionnez les prestations qui vous correspondent le mieux.",
  },
  {
    icon: "check",
    step: "03",
    title: "Personnalisation",
    desc: "Nous adaptons chaque moindre détail à votre thème unique.",
  },
  {
    icon: "check",
    step: "04",
    title: "Votre grand jour",
    desc: "Profitez pleinement de chaque instant magique et inoubliable.",
  },
];
  ...
  return createPortal(
    ...
    >
      <motion.div
        ...
        style={{
          boxShadow:
            "0 40px 100px rgba(233,30,140,0.25), 0 8px 40px rgba(0,0,0,0.3)",
        }}
      >
        <div className="relative h-[220px] overflow-hidden md:h-[320px]">
          ...
          {svc.tag && (
            <div
              className="absolute left-4 top-4 rounded-full px-3.5 py-1.5 text-xs font-bold text-white shadow-lg md:left-[18px] md:top-[18px]"
              style={{
        ...
        <div className="p-5 md:p-9">
          <div className="mb-6 flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div>
              <div className="mb-2 flex items-center gap-3">
                ...
                >
                  <Icon
                    d={icons[svc.icon as keyof typeof icons]}
                    size={20}
                    stroke="#fff"
                  />
                </div>
                <h2
                  className="m-0 font-serif text-2xl font-black leading-tight md:text-[28px]"
                  style={{ color: DARK }}
                >
                  {svc.title}
                </h2>
            ...
            <div className="shrink-0 rounded-2xl bg-[#fdf6f9] px-4 py-3 text-left md:text-right">
              <p className="m-0 mb-1 text-[11px] uppercase tracking-[0.08em] text-[#aaa]">
                À partir de
              </p>
              <p
                className="m-0 text-3xl font-black leading-none"
                style={{ color: PINK }}
              >
                {svc.price}
              </p>
          ...
          <div className="mb-6 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-3 rounded-2xl border border-[#fce4ec] bg-[#fdf6f9] px-4 py-3"
              >
                <span className="text-xl">{m.emoji}</span>
                <div>
                  <p className="m-0 text-[11px] uppercase tracking-[0.06em] text-[#aaa]">
                    {m.label}
                  </p>
                  <p className="m-0 text-sm font-bold" style={{ color: DARK }}>
                    {m.val}
                  </p>
                </div>
              </div>
          ...
          <div className="mb-6">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.1em] text-[#aaa]">
              Ce qui est inclus
            </p>
              ...
              {svc.details.map((d, i) => (
                ...
                >
                  <span
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(233,30,140,0.15), rgba(233,30,140,0.25))",
                    }}
                  >
                    <Icon
                      d={icons.check}
          ...
          <div
            className="mb-6 rounded-2xl border-l-4 p-5"
            style={{
          ...
          >
            ...
            <p className="my-2 text-sm italic leading-7 text-[#555]">
              "{svc.testimonial.text}"
            </p>
            <p className="m-0 text-xs font-bold" style={{ color: PINK }}>
    ...
    >
      ...
      >
        ...
        >
          ...
          <p
            style={{ fontSize: 22, fontWeight: 900, color: "#fff", margin: 0 }}
          >
            {pkg.badge}
          </p>
        </div>
    ...
    >
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(150deg, #fff0f7 0%, #fce4ec 55%, #f8bbd0 100%)",
          minHeight: 320,
        }}
      >
        {/* Animated blobs */}
        ...
        >
          ...
          >
            ...
            >
              Découvrez tous les services dont vous avez besoin pour faire de
          ...
          >
            <div
              style={{
                ...
                overflow: "hidden",
                boxShadow:
                  "0 28px 80px rgba(233,30,140,0.28), 0 6px 28px rgba(0,0,0,0.14)",
              }}
            >
              <img
                src={photo8}
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", padding: "28px 48px" }}>
          ...
          >
            {stats.map((s, i) => (
              ...
              >
                <span
                  style={{ fontSize: 26, display: "block", marginBottom: 4 }}
                >
                  {s.emoji}
                </span>
                <p
      ...
      {/* ── SERVICES GRID ────────────────────────────────────────────────── */}
      <div
        style={{ maxWidth: 1140, margin: "0 auto", padding: "88px 48px 70px" }}
      >
      ...
      {/* ── BOTTOM CTA ───────────────────────────────────────────────────── */}
      <div
        style={{ maxWidth: 1140, margin: "0 auto", padding: "0 48px 100px" }}
      >
        <motion.div
        ...
        >
          ...
          >
            ...
            >
              Notre équipe de conseillers dédiés est à votre écoute pour vous
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <motion.button
                whileHover={{
                  scale: 1.03,
                  boxShadow: "0 6px 24px rgba(233,30,140,0.32)",
                }}
                whileTap={{ scale: 0.97 }}
                style={{
                  flex: 1,
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                Profitez de <strong>10% de réduction</strong> sur l'ensemble de
                nos prestations pour toute réservation avant le{" "}
                <strong>30 Juin 2025</strong>.
              </p>
              <motion.button
                whileHover={{
                  scale: 1.04,
