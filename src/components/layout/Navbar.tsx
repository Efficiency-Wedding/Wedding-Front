    ...
    >
      <nav className="flex justify-between items-center px-4 md:px-10 py-4">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg hover:bg-rose-soft/80 transition flex items-center justify-center shrink-0 z-50 text-foreground"
        >
      ...
      {open && (
        <div
          className="md:hidden border-t border-[#f7c0f7]/35 px-6 py-5 flex flex-col gap-4"
          style={{
            background:
