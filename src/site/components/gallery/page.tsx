            ...
            <div className="flex items-center gap-2 w-max lg:w-auto lg:flex-wrap">
              {categories.map((cat) => (
                <button
                  ...
                  className={`relative px-5 py-2 text-xs font-bold tracking-widest uppercase rounded-full transition-all duration-300 active:scale-[0.96] cursor-pointer whitespace-nowrap ${
