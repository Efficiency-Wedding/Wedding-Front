  ...
  return (
    ...
    <div className="page-entrance min-h-screen w-full overflow-x-hidden bg-background text-foreground">
      ...
      <motion.section {...sectionMotion} className="section-entrance max-w-[880px] mx-auto text-center px-4 sm:px-6 py-16 sm:py-24 md:px-12">
        ...
        <p className="font-script text-[36px] sm:text-[44px] text-rose mb-2">

          Une collaboration unique

        </p>

        <h2 className="font-serif text-[26px] sm:text-[32px] lg:text-[38px] font-medium text-violet tracking-[2px] sm:tracking-[3px] lg:tracking-[4px] uppercase mt-4 mb-5">
          ...
          {FORFAITS.map((f) => {
            ...
            return (
              ...
              <motion.article
                ...
                className={`relative ${cardColors.bg} border ${cardColors.border} p-[42px_22px_34px] sm:p-[50px_32px_40px] text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_24px_50px_rgba(0,0,0,0.08)] overflow-hidden rounded-2xl
              ...
              >
                ...
                <Link
                  to="/reservation"
                  className={`block w-full py-3 text-center text-[11px] tracking-[3px] font-semibold uppercase transition-all duration-200 text-white rounded-full ${cardColors.button}`}
                >
      ...
      <section className="text-center px-4 sm:px-6 py-20 sm:py-28 bg-gradient-to-r from-[#FFF8F8] to-[#F8F5FF] md:px-12">
        ...
        <p className="font-script text-[40px] sm:text-[52px] text-[#E8A0A0] mb-2">
